    ...
    <div className="space-y-3">
      ...
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'samstag' | 'sonntag')}>
        <TabsList className="grid w-full grid-cols-2 h-8">
          <TabsTrigger value="samstag" className="text-xs">
            Sa ({filteredSamstag.length})
          </TabsTrigger>
          <TabsTrigger value="sonntag" className="text-xs">
            So ({filteredSonntag.length})
          </TabsTrigger>
        </TabsList>
          ...
          <div className="bg-white rounded-lg border">
            <div className="p-2 border-b">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-medium text-sm">{spieleData.samstag.datum}</h3>
              </div>
            </div>
            <div className="p-2">
        ...
        <TabsContent value="sonntag" className="space-y-2">
          <div className="bg-white rounded-lg border">
            <div className="p-2 border-b">
              <div className="flex items-center gap-2">
                <Calendar className="h-4 w-4 text-green-600" />
                <h3 className="font-medium text-sm">{spieleData.sonntag.datum}</h3>
              </div>
            </div>
            <div className="p-2">
