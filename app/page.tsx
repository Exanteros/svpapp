        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link href="/helfer" className="text-gray-700 hover:text-orange-600 font-medium transition-colors">
                Helfer
              </Link>
              <Link href="/anmeldung" className="text-gray-700 hover:text-orange-600 font-medium transition-colors">
                Anmeldung
              </Link>
              <Link href="/admin">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              ...
              <Link href="/helfer" className="group bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200 hover:-translate-y-1">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-50 rounded-lg flex items-center justify-center mb-3 sm:mb-4 mx-auto group-hover:bg-orange-100 transition-colors">
                  <Users className="h-5 w-5 sm:h-6 sm:w-6 text-orange-600" />
                </div>
                <h4 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Helfer-Anmeldung</h4>
                <p className="text-xs sm:text-sm text-gray-600">Als Helfer anmelden</p>
              </Link>
